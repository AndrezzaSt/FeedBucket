 ...
 <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          ...
          <li>Profissionais de Arte visual</li>
        </ol>
        <h2>Profissionais de Arte visual</h2>
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-app">Concept art</li>
              <li data-filter=".filter-card">Animação</li>
              <li data-filter=".filter-web">Prop Design</li>
            </ul>
          </div>
        </div>
            ...
            <div class="portfolio-wrap">
              ...
              <div class="portfolio-info">
                ...
                <div class="portfolio-links">
                  ...
                  <a href="portfolio-detalhes.php" title="More Details"><i class="bx bx-link"></i></a>
                </div>
              </div>
            </div>
          </div>
