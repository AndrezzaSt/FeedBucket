 ...
 <section id="breadcrumbs" class="breadcrumbs">
      <div class="container">
        ...
        <ol>
          ...
          <li>Profissionais de Musica</li>
        </ol>
        <h2>Profissionais de Musica</h2>
        ...
        <div class="row">
          <div class="col-lg-12 d-flex justify-content-center">
            <ul id="portfolio-flters">
              ...
              <li data-filter=".filter-app">Eletronica</li>
              <li data-filter=".filter-card">Pop</li>
              <li data-filter=".filter-web">Rock</li>
            </ul>
          </div>
        </div>
